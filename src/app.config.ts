export default defineAppConfig({
  pages: ["pages/index/index", "pages/myNote/index", "pages/publish/index", "pages/mine/index", "pages/login/index", 'pages/register/index', 'pages/detail/index', 'pages/edit/index'],
  window: {
